...
# Импортируем torch_pruning для настоящей структурной обрезки
try:
    import torch_pruning as tp
    TORCH_PRUNING_AVAILABLE = True
    print("torch_pruning successfully imported")
except ImportError:
    TORCH_PRUNING_AVAILABLE = False
    print("ERROR: torch_pruning not installed. Run: pip install torch-pruning")
    sys.exit(1)
