...
from fedcore.algorithm.low_rank.svd_tools import decompose_module_in_place
...
def test_conv1d():
    ...
    decompose_module_in_place(DC1, compose_mode='two_layers')
...
def test_conv2d():
    ...
    DC1 = nn.Sequential(deepcopy(C1))
    decompose_module_in_place(DC1, compose_mode='two_layers', decomposing_mode='channel')
    DC1[0]._anti_three_layers_compose()
    DC1[0].compose_weight_for_inference()
