...
def parse_args():
    ...
    parser.add_argument('--pruning_type', default='l1', type=str, help='pruning type',
...
def forward(self, x):
    ...
    /blob/054c763fcaa7d241564439ae05fbe919ed85e614/timm/models/vision_transformer.py#L79"""
    B, N, C = x.shape
...
def main():
    ...
    pruner = tp.pruner.MetaPruner(
        ...
        round_to=8
        # round_to=8 for fp16 and round_to=4 for tf32 https://docs.nvidia.com/deeplearning/performance/dl-performance-convolutional/index.html
    )
    ...
    for it in range(10):
        ...
        print("Iter {}, Pruned Latency: {:.2f} ms, Pruned MACs: {:.2f} G, Pruned Params: {:.2f} M".format(it,
                                                                                                          pruned_latency,
                                                                                                          pruned_macs / 1e9,
                                                                                                          pruned_params / 1e6))
