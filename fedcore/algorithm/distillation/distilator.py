...
class BaseDistilator(BaseCompressionModel):
    ...
    def finetune(self, input_data: InputData,
        ...
        for epoch in range(self.epochs):
            pbar = tqdm(enumerate(input_data.features.train_dataloader),
            ...
            for idx, batch in pbar:
                ...
                output_dict = {'student_logits': student_outputs.logits,
                ...
                total_loss = self._calc_losses(student_outputs.loss, train_params, output_dict)
                step += 1
            ...
            torch.save({'model': self.student_model,
                        'state_dict': self.student_model.state_dict(),
                        'optimizer_state': optimizer.state_dict()},
                       f'{self.output_dir}/ckpt_{epoch}.pth')

    def _fit_distil_model(self, input_data: InputData, distilation_params: TrainParams = None):
