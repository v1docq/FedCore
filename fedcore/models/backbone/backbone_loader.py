...
def load_backbone(torch_model: Union[str, Callable], model_impl: Callable = None):
    ...
    if is_backbone_torch:
        torch_model = BACKBONE_MODELS[torch_model]() if is_backbone_torch else torch_model
