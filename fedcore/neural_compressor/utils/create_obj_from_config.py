...
from fedcore.neural_compressor.data import DATALOADERS, FILTERS, TRANSFORMS, Datasets
from fedcore.neural_compressor.metric import METRICS
...
def create_train_func(
    ...
    from fedcore.neural_compressor.compression.distillation.optimizers import Optimizers
