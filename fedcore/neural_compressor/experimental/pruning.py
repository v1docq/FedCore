...
class Pruning(Component):
    ...
    def generate_pruners(self):
        ...
        for name in self.cfg.pruning.approach:
            assert (
                name == "weight_compression" or name == "weight_compression_pytorch"
            ), "now we only support weight_compression and weight_compression_pytorch"

            if self.cfg.pruning.approach.weight_compression_pytorch is not None:
            ...
            if self.cfg.pruning.approach.weight_compression is not None:
