...
from fedcore.neural_compressor.tensorflow.utils.utility import version1_lt_version2
...
def slim_session(
    ...
    from fedcore.neural_compressor.tensorflow.utils.nets_factory import (
        TFSlimNetsFactory,
    )
    ...
    def report_sparsity(self):
        ...
        for index, layer in enumerate(tf.keras.models.load_model(self._model).layers):
            ...
            if weights.ndim in param_dims:
                param_size, sparse_param_size, dense_param_size = self.compute_sparsity(
                    weights
                )
