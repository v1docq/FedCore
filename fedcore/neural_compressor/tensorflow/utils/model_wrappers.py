...
def get_model_type(model):
    ...
    Returns:
        string: model type
    """
    from fedcore.neural_compressor.tensorflow.quantization.utils.utility import is_ckpt_format, is_saved_model_format
...
def validate_and_inference_input_output(graph_def, input_tensor_names, output_tensor_names):
    ...
    """
    from fedcore.neural_compressor.tensorflow.quantization.utils.utility import get_input_output_node_names
...
def _get_graph_from_saved_model_v2(saved_model_dir, input_tensor_names, output_tensor_names):
    ...
    from fedcore.neural_compressor.tensorflow.quantization.utils.utility import parse_saved_model
...
def slim_session(model, input_tensor_names, output_tensor_names, **kwargs):  # pragma: no cover
    ...
    from fedcore.neural_compressor.tensorflow.utils.nets_factory import TFSlimNetsFactory
...
class TensorflowBaseModel(BaseModel):
    ...
    def input_tensor(self):
        """Return input tensor."""
        from fedcore.neural_compressor.tensorflow.quantization.utils.utility import get_tensor_by_name
...
class TensorflowLLMModel(TensorflowSavedModelModel):
    ...
    def adjust_weight(self, graph_def):
        ...
        from fedcore.neural_compressor.tensorflow.quantization.utils.utility import reconstruct_saved_model
    ...
    def save(self, root=None):
        ...
        from fedcore.neural_compressor.tensorflow.quantization.utils.utility import parse_saved_model, reconstruct_saved_model
...
class TensorflowCheckpointModel(TensorflowBaseModel):
    ...
    def graph_def(self):
        ...
        from fedcore.neural_compressor.tensorflow.quantization.utils.utility import _parse_ckpt_bn_input
