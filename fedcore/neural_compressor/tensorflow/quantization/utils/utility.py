...
from fedcore.neural_compressor.tensorflow.quantization.utils.graph_util import GraphAnalyzer, GraphRewriterHelper
...
def get_graph_def(model, outputs=[], auto_input_output=False):
    ...
    from fedcore.neural_compressor.tensorflow.utils import BaseModel, Model
